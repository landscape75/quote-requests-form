    ...
    <div className="flex items-center rounded-xl max-w-lg w-full mx-auto shadow-xl justify-center bg-white dark:bg-mag-grey-600 pt-4 pb-4 px-4 mb-0 sm:px-3 lg:px-6">
      <div className="max-w-lg w-full space-y-2 sm:space-y-2 md:space-y-2">
        ...
        <form className="mt-3 space-y-6 md:space-y-3">
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-4 sm:items-start sm:pt-2">
              ...
              <div className="mt-1 mb-2 sm:mt-1 md:col-span-1 sm:col-span-3 lg:col-span-2">
                <input
                  id="username"
                  name="username"
                  type="text"
            ...
            <div className="sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-4 sm:items-start sm:pt-3">
              ...
              <div className="mt-1 mb-2 sm:mt-0 md:col-span-1 sm:col-span-3 lg:col-span-2">
                <input
                  id="current-password"
        ...
        <div className="inline-flex w-full space-x-2 justify-center pt-3">
          <button
            className="w-full rounded-md border border-transparent shadow-md px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm"
            disabled={loading}
          ...
          <button
            className="w-full rounded-md border border-transparent shadow-md px-4 py-2 bg-mag-blue text-base font-medium text-white hover:bg-mag-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-mag-blue-500 sm:text-sm"
            disabled={loading}
