...
function UserInfo({ user, toggle, setUser }) {
  ...
  return (
    ...
    <div className="flex items-center rounded-lg max-w-lg w-full mx-auto shadow-lg justify-center bg-white dark:bg-mag-grey-600 pt-4 pb-4 px-4 mb-4 sm:px-3 lg:px-6">
