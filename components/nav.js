      ...
      {edit && (
        ...
        <div class="fixed z-10 inset-0 overflow-y-auto">
          <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-none rounded-lg px-0 pt-0 pb-0 text-left overflow-hidden transform transition-all sm:my-0 sm:align-middle sm:max-w-xl sm:w-full sm:p-0" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            {/* <div className="w-full md:w-1/2 lg:w-1/3 sm:w-full mx-auto mt-10"> */}
              <UserInfo
                toggle={setEdit}
                setUser={setUser}
